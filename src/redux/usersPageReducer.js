...
export const toggleIsFetching = (isFetching)=> ({type: TOGGLE_IS_FETCING, isFetching: isFetching})
export const toggleFollowingInProgress = (isFetching)=> ({type: TOGGLE_IS_FETCING, isFetching})
